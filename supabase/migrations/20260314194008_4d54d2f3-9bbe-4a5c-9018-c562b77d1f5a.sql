...
-- Add card_last_four to receipts
ALTER TABLE public.receipts ADD COLUMN IF NOT EXISTS card_last_four TEXT;

-- Update trigger to also copy card_last_four and cheque_date
