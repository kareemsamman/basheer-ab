...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "بحث برقم البطاقة", href: "/card-search", icon: CreditCard },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "كشوفات انتاج", href: "/reports/company-settlement", icon: BarChart3, adminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "التوريسات", href: "/admin/correspondence", icon: Mail },
